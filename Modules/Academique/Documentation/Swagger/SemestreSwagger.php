...
abstract class SemestreSwagger
{
    #[OA\Get(
        path: '/api/v1/academique/semestres',
        summary: 'Liste des semestres',
        tags: ['Academique - Semestres'],
        parameters: [
    ...
    #[OA\Get(
        path: '/api/v1/academique/semestres/{id}',
        summary: 'Détail d\'un semestre',
        tags: ['Academique - Semestres'],
        parameters: [
