...
abstract class UeSwagger
{
    #[OA\Get(
        path: '/api/v1/academique/unites-enseignement',
        summary: 'Liste des unités d\'enseignement (UE)',
        tags: ['Academique - UE'],
        parameters: [
    ...
    #[OA\Get(
        path: '/api/v1/academique/unites-enseignement/{id}',
        summary: 'Détail d\'une unité d\'enseignement (UE)',
        tags: ['Academique - UE'],
        parameters: [
    ...
    #[OA\Post(
        path: '/api/v1/academique/unites-enseignement',
        summary: 'Créer une unité d\'enseignement (UE)',
        tags: ['Academique - UE'],
    ...
    #[OA\Put(
        path: '/api/v1/academique/unites-enseignement/{id}',
        summary: 'Modifier une unité d\'enseignement (UE)',
        tags: ['Academique - UE'],
    ...
    #[OA\Delete(
        path: '/api/v1/academique/unites-enseignement/{id}',
        summary: 'Supprimer une unité d\'enseignement (UE)',
        tags: ['Academique - UE'],
        parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'string', format: 'uuid'))],
        responses: [
