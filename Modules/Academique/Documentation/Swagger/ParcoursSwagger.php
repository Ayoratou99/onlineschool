...
abstract class ParcoursSwagger
{
    #[OA\Get(path: '/api/v1/academique/parcours', summary: 'Liste des parcours', tags: ['Academique - Parcours'], parameters: [
    ...
    #[OA\Get(path: '/api/v1/academique/parcours/{id}', summary: 'Détail d\'un parcours', tags: ['Academique - Parcours'], parameters: [
    ...
    #[OA\Post(path: '/api/v1/academique/parcours', summary: 'Créer un parcours', tags: ['Academique - Parcours'], requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ['filiere_id', 'code', 'libelle'], properties: [
        new OA\Property(property: 'filiere_id', type: 'string', format: 'uuid'),
    ...
    #[OA\Put(path: '/api/v1/academique/parcours/{id}', summary: 'Modifier un parcours', tags: ['Academique - Parcours'], parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'string', format: 'uuid'))], requestBody: new OA\RequestBody(required: false, content: new OA\JsonContent(properties: [
        new OA\Property(property: 'filiere_id', type: 'string', format: 'uuid'),
        new OA\Property(property: 'code', type: 'string', maxLength: 50),
        new OA\Property(property: 'libelle', type: 'string', maxLength: 255),
        new OA\Property(property: 'description', type: 'string', nullable: true),
