...
abstract class BatimentSwagger
{
    #[OA\Get(path: '/api/v1/academique/batiments', summary: 'Liste des bâtiments', tags: ['Academique - Batiments'], parameters: [
    ...
    #[OA\Get(path: '/api/v1/academique/batiments/{id}', summary: 'Détail d\'un bâtiment', tags: ['Academique - Batiments'], parameters: [
    ...
    #[OA\Post(path: '/api/v1/academique/batiments', summary: 'Créer un bâtiment', tags: ['Academique - Batiments'], requestBody: new OA\RequestBody(required: true, content: new OA\JsonContent(required: ['etablissement_id', 'code', 'libelle'], properties: [
        new OA\Property(property: 'etablissement_id', type: 'string', format: 'uuid'),
    ...
    #[OA\Put(path: '/api/v1/academique/batiments/{id}', summary: 'Modifier un bâtiment', tags: ['Academique - Batiments'], parameters: [new OA\Parameter(name: 'id', in: 'path', required: true, schema: new OA\Schema(type: 'string', format: 'uuid'))], requestBody: new OA\RequestBody(required: false, content: new OA\JsonContent(properties: [
        new OA\Property(property: 'etablissement_id', type: 'string', format: 'uuid'),
        new OA\Property(property: 'code', type: 'string', maxLength: 50),
        new OA\Property(property: 'libelle', type: 'string', maxLength: 255),
        new OA\Property(property: 'adresse', type: 'string', nullable: true),
